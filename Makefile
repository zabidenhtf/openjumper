...
ifdef PLATFORM
ifeq ($(PLATFORM),WIN64)
	$(CXX) $(TARGETS) $(GAME_TARGETS) $(SCENE_TARGETS) $(GAME_COMPONENTS_TARGETS) $(SCENE_ENTITIES_TARGETS) $(INCLUDES) \
	$(CXXFLAGS) \
	...
	$(ASSIMP_INCLUDE) $(ASSIMP_LIB_LINUX) \
	$(PNG_INCLUDE) $(PNG_LIB_LINUX) \
	$(GLM_INCLUDE)  \
	$(GLAD_INCLUDE) $(GLAD_TARGETS) \
	$(SIMPLE_INI_INCLUDE) \
	-o $(EXEC)
